<script lang="ts" module>
  ...
  export const sidebarMenuButtonVariants = tv({
    ...
    variants: {
      ...
      size: {
        default: "h-8 text-body-2",
        sm: "h-7 text-xs",
        lg: "h-12 text-body-2 group-data-[collapsible=icon]:p-0!",
      },
    },
    defaultVariants: {
      variant: "default",
