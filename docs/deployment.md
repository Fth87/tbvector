...
Proyek menggunakan adapter static resmi SvelteKit dengan fallback `200.html`. `pnpm build` menghasilkan folder `build/` yang dapat dipasang pada static hosting.
